...
const Hero = () => {
    return (
        <div className='isolate'>
            ...
            bg-amber-400 dark:bg-amber-500 rounded-full blur-3xl opacity-20'></div>
            </div>
                ...
                <div className='flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16'>
                    <div className='flex-1 space-y-6 lg:space-y-7'>
                        <div className='space-y-4 lg:space-y-5'>
                            <div className='flex items-center'>
                                ...
                                <h2 className='inline-block px-3 py-1.5 lg:px-4
                            lg:py-2 rounded-full bg-neutral-900 text-amber-400
                            font-medium text-sm backdrop-blur-sm border
                            ...
                            font-extrabold tracking-tight text-neutral-900 dark:text-white'>
                                <span className='block mb-1'>Design</span>
                                <span className='bg-clip-text text-transparent bg-gradient-to-r
                                from-amber-500 via-amber-400 to-amber-600'>Without Limits</span>
                            </h1>
                            <p className='text-base lg_text-lg text-neutral-700 dark:text-neutral-300 max-w-2xl font-light'>
                                Elevate your web projects with our streamlined design system
                                powered by the latest
                                Tailwind CSS v4. Create stunning user experiences with
                            ...
                            <div className='flex gap-3 items-center'>
                                ...
                                dark:text-neutral-400 font-medium '>Transition seamlessly</p>
                            </div>
                        </div>
                        <div className='flex flex-wrap gap-3 lg:gap-4'>
                            <button className='px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-900 hover:bg-black text-white
                            dark:bg-amber-500 dark:hover:bg-amber-600 dark:text-neutral-900 font-medium shadow-lg
                            ...
                            <button className='px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-100 hover:bg-neutral-200
                        ...
                        <div className='flex flex-col sm:flex-row gap-5 sm:items-center pt-6 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800'>
                            <div className='flex -space-x-3'>
                                <img src="https://randomuser.me/api/portraits/women/21.jpg" alt="random user picture" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full
                                border-2 border-white dark:border-neutral-900 object-cover'/>
                                <img src="https://randomuser.me/api/portraits/men/12.jpg" alt="random user picture" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full
                                border-2 border-white dark:border-neutral-900 object-cover'/>
                                <img src="https://randomuser.me/api/portraits/women/24.jpg" alt="random user picture" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full
                                border-2 border-white dark:border-neutral-900 object-cover'/>
                                <span className='flex items-center justify-center w-9 h-9 lg:w-10 lg:h-10 rounded-full
                                border-2 border-white dark:border-neutral-900 bg-neutral-900 dark:bg-amber-500
                                text-white dark:text-neutral-900 text-xs font-medium'>
                                    +5K
                                </span>
                            </div>
                    ...
                    <div className='flex-1 w-full'>
                        <div className='relative'>
                            ...
                            <div className='relative bg-white dark:bg-neutral-900 p-4
                            lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800'>
                                <div className='flex items-center justify-between mb-3 lg:mg-4'>
                                ...
                                <div className='h-56 md:h-64 lg:h-60 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative'>
                                    <img src="/images/code-light.png" alt="codesnippet for light" className='w-full h-full object-cover object-left-top dark:hidden' />
                                    <img src="/images/code-dark.png" alt="codesnippet for light" className='w-full h-full object-cover object-left-top dark:block' />
                                    <div className='absolute bottom-4 right-4'>
                                        <div className='w-12 h-12 lg:w-14 lg:h-14 rounded-full
                                            bg-gradient-to-r from-amber-500 to-indigo-900
                                            flex items-center justify-center text-white shadow-lg
                                            animate-pulse'>
                                            <i className='bx bxs-brightness-half text-xl lg:text-2xl' />
                                        </div>
                                    </div>
                                </div>
                                <div className='mt-3 lg:mt-4 flex justify-between items-center'>
                                    <div className='flex gap-2'>
                                        <span className='px-2.5 py-1 lg:px-3 rounded-full bg-neutral-900 text-amber-400 text-xs font-medium flex items-center'>
                                            <i className='bx bx-tailwind-css mr-1'></i> Tailwind v4
                                        </span>
                                        <span className='px-2.5 py-1 lg:px-3 rounded-full
                                        bg-neutral-100 dark:bg-neutral-800 text-indigo-900 dark:text-indigo-400 border
                                        border-neutral-200 dark:border-neutral-700 text-xs font-medium flex items-center'>
                                            <i className='bx bxl-react mr-1'></i> React
                                        </span>
                                    </div>
                                    <button className='w-8 h-8 lg:w-9 lg:h-9 xl:w-10 xl:h-10
                                    flex items-center justify-center rounded-full bg-amber-500 text-neutral-900 hover:bg-amber-600 transition'>
